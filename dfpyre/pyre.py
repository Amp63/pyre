...
def function(function_name: str, *args: ArgValue, tags: dict[str, str]={}, codeblocks: list[CodeBlock]=[], author: str|None=None) -> DFTemplate:
    """
...
def process(process_name: str, *args: ArgValue, tags: dict[str, str]={}, codeblocks: list[CodeBlock]=[], author: str|None=None) -> DFTemplate:
    """
...
def call_function(function_name: str, *args: ArgValue) -> CodeBlock:
    """
...
def start_process(process_name: str, *args: ArgValue, tags: dict[str, str]={}) -> CodeBlock:
    """
    Represents a Call Function codeblock.
...
def player_action(action_name: PLAYER_ACTION_ACTION, *args: ArgValue, target: Target=DEFAULT_TARGET, tags: dict[str, str]={}) -> CodeBlock:
    """
...
def entity_action(action_name: ENTITY_ACTION_ACTION, *args: ArgValue, target: Target=DEFAULT_TARGET, tags: dict[str, str]={}) -> CodeBlock:
    """
...
def game_action(action_name: GAME_ACTION_ACTION, *args: ArgValue, tags: dict[str, str]={}) -> CodeBlock:
    """
...
def if_player(action_name: IF_PLAYER_ACTION, *args: ArgValue, target: Target=DEFAULT_TARGET, tags: dict[str, str]={}, inverted: bool=False, codeblocks: list[CodeBlock]=[]) -> list[CodeBlock]:
    """
...
def if_entity(action_name: IF_ENTITY_ACTION, *args: ArgValue, target: Target=DEFAULT_TARGET, tags: dict[str, str]={}, inverted: bool=False, codeblocks: list[CodeBlock]=[]) -> list[CodeBlock]:
    """
...
def if_game(action_name: IF_GAME_ACTION, *args: ArgValue, tags: dict[str, str]={}, inverted: bool=False, codeblocks: list[CodeBlock]=[]) -> list[CodeBlock]:
    """
...
def if_variable(action_name: IF_VAR_ACTION, *args: ArgValue, tags: dict[str, str]={}, inverted: bool=False, codeblocks: list[CodeBlock]=[]) -> list[CodeBlock]:
    """
...
def repeat(action_name: REPEAT_ACTION, *args: ArgValue, tags: dict[str, str]={}, sub_action: SUBACTION|None=None, inverted: bool=False, codeblocks: list[CodeBlock]=[]) -> CodeBlock:
    """
...
def control(action_name: CONTROL_ACTION, *args: ArgValue, tags: dict[str, str]={}) -> CodeBlock:
    """
...
def select_object(action_name: SELECT_OBJ_ACTION, *args: ArgValue, tags: dict[str, str]={}, sub_action: SUBACTION|None=None, inverted: bool=False) -> CodeBlock:
    """
...
def set_variable(action_name: SET_VAR_ACTION, *args: ArgValue, tags: dict[str, str]={}) -> CodeBlock:
    """
